        ...
        try:
            ...
            for turtle in data:
                ...
                turtles_data.append({
                    ...
                    'distance_from_release': turtle['motion']['distance_from_release'],
                    'avg_speed_from_release': turtle['motion']['avg_speed_from_release'],
                ...
                self._full_data = pd.DataFrame(turtles_data,
                                               columns=['id', 'name', 'species', 'last_move_datetime',
                                                        'distance_from_release', 'avg_speed_from_release',
                                                        'time_from_last_move', 'time_from_release', 'time_tracked',
                                                        'description',
                                                        'project', 'biography'])
            return True
